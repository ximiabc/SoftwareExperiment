...
<body>
	...
	<div class="rightinfo">
				...
				<s:iterator value="pageBean.recordList" var="n" status="indexs">
					<tr>
						...
						<td><c:if test="${n.view == true }">
								<a href="Manageruleunshow?id=${n.id }">关闭</a>
							</c:if> <c:if test="${n.view != true }">
								<a href="Manageruleshow?id=${n.id }">开启</a>
							</c:if>
						</td>
					</tr>
				</s:iterator>
		...
		<div class="pageing">
			<ul class="page">
				<li><a href="Managerulehistory?pageNum=${pageNums -1}"><</a></li>
				<s:iterator begin="pageBean.beginPageIndex"
					...
					<li
						...
						<c:if test="${pageBean.currentPage == pageNums }">
							...
							<a href="Managerulehistory?pageNum=${pageNums }">${pageNums }</a>
						</c:if>
					</li>
				</s:iterator>

				<li><a href="Managerulehistory?pageNum=${pageNums }">></a></li>
			</ul>
		</div>
	</div>
</body>
