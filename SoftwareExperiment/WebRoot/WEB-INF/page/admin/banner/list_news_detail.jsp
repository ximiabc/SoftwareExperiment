	...
	<div class="detail_center">
		<div class="detail_centerbg">
			...
			<div class="detail_foot">
				<br /> <br /> <br />
				<p>
					<a href="Managenewsview?id=${up.id }" class="a14 underline" ><c:if test="${up != null }">上一篇：${up.titles }</c:if></a> 
					<a href="Managenewsview?id=${down.id }" class="a14 underline right"><c:if test="${down != null }">下一篇：${down.titles }</c:if></a>
				</p>
			</div>
		</div>
	</div>
