...
<body>
	...
	<div class="rightinfo">
		...
		<div class="pageing">
			<ul class="page">
				<li><a href="Managedevicehistory?pageNum=${pageNums -1}"><</a></li>
				<s:iterator begin="pageBean.beginPageIndex"
					...
					<li
						...
						<c:if test="${pageBean.currentPage == pageNums }">
							...
							<a href="Managedevicehistory?pageNum=${pageNums }">${pageNums }</a>
						</c:if>
					</li>
				</s:iterator>

				<li><a href="Managedevicehistory?pageNum=${pageNums }">></a></li>
			</ul>
		</div>
	</div>
</body>
