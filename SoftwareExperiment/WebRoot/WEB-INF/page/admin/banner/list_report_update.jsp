...
<body>
	...
	<div class="rightinfo">
				...
				<s:iterator value="pageBean.recordList" var="n" status="indexs">
					<tr>
						...
						<td><c:if test="${n.view == true }">
								<a href="Managereportunshow?id=${n.id }">关闭</a>
							</c:if> 
							<c:if test="${n.view != true }">
								<a href="Managereportshow?id=${n.id }">开启</a>
							</c:if>
						</td>
					</tr>
				</s:iterator>
		...
		<div class="pageing">
			<ul class="page">
				<li><a href="Managereportupdate?pageNum=${pageNums -1}"><</a></li>
				<s:iterator begin="pageBean.beginPageIndex"
					...
					<li
						...
						<c:if test="${pageBean.currentPage == pageNums }">
							...
							<a href="Managereportupdate?pageNum=${pageNums }">${pageNums }</a>
						</c:if>
					</li>
				</s:iterator>

				<li><a href="Managereportupdate?pageNum=${pageNums }">></a></li>
			</ul>
		</div>
	</div>
